...
import CareerList from "@/components/materials/career-list";
    ...
    return (
        <div className='container pt-5'>
            ...
            <div className='flex md:flex-row flex-col md:items-center gap-4 mt-4'>
                ...
                <Button className="h-[50px] rounded-xl text-sm px-10 justify-center flex flex-row items-center gap-2 dark:bg-primary/10">
