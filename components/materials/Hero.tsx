  ...
  return (
    <>
      <div className="flex flex-col w-full h-[300px] md:h-[480px] items-center justify-center relative mt-20">
        ...
        {/* Canvas */}
        <div className="absolute border-b top-0 md:top-20 border-gray-200 border-dashed left-0 right-0 animate-pulse" />
        <div className="absolute border-b bottom-0 md:bottom-20 border-gray-200 border-dashed left-0 right-0 animate-pulse" />
