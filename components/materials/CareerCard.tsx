...
import {Bookmark, Briefcase, Building, Clock2, MapPin} from "lucide-react";

export default function CareerCard({data}: { data: any }) {
    return (
        <div className="bg-white rounded-lg p-4">
            ...
            <div className="flex flex-row items-center gap-3 mt-3">
                ...
                <button className="text-xs bg-primary px-4 py-2 rounded text-white">
                    Details
                </button>
