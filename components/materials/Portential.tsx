        ...
        <section className='mt-20 px-10' >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-20' >
                <div className='flex flex-col items-center justify-center gap-6' >
                    ...
                    <p className='lg:text-2xl md:text-lg text-lg font-semibold text-center' >Effortless Job Posting for <br />Recruiters</p>
                    <p className='text-sm'>Post jobs in minutes and reach top talent.</p>
                </div>
                ...
                <div className='flex flex-col items-center justify-center gap-3' >
                    ...
                    <p className='lg:text-2xl md:text-lg text-lg font-semibold text-center' >Streamlined Job Search for <br /> Candidates</p>
                    <p className='text-sm'>Find your dream job with just a few clicks.</p>
                </div>
                ...
                <div className='flex flex-col items-center justify-center gap-3' >
                    ...
                    <p className='lg:text-2xl md:text-lg text-lg font-semibold text-center' >Diverse Freelance Job <br /> Opportunities Available</p>
                    <p className='text-sm'>Explore freelance gigs that match your skills.</p>
                </div>
            </div>
        </section>
    )
