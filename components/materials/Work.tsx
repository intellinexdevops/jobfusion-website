...
export default function Work() {
    return (
        <section className='mt-20 px-10' >
            <p className='text-center text-3xl font-semibold' >Unlock Your Career Potential <br /> with Us</p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-20' >
                ...
                <div className='flex flex-col items-center justify-center gap-3' >
                    ...
                    <p className='text-xl font-medium text-center' >Streamlined Job Search for <br /> Candidates</p>
                    <p className='text-xs'>Find your dream job with just a few clicks.</p>
                </div>
                ...
                <div className='flex flex-col items-center justify-center gap-3' >
                    ...
                    <p className='text-xl font-medium text-center' >Diverse Freelance Job <br /> Opportunities Available</p>
                    <p className='text-xs'>Explore freelance gigs that match your skills.</p>
                </div>
            </div>
        </section>
    )
