    ...
    <header className="sticky top-0 z-50 bg-background">
      <div className="flex flex-row items-center justify-between py-3 px-5">
        ...
        <div className="flex flex-row items-center gap-3">
          <div
            className="flex flex-row items-center bg-gray-100 border p-2 rounded-xl gap-2 cursor-pointer"
              ...
              <div className="flex flex-col gap-1">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="border rounded-xl me-[50px] mt-4 max-w-60">
                      ...
                      <div className="mt-3 pb-4 border-b flex flex-col gap-3">
                        {company.map((com, idx) => (
                          <div
                            className="flex flex-row items-center gap-2 cursor-pointer hover:bg-gray-100 px-2 py-1 rounded-md transition-all duration-200 ease-linear"
                            key={idx}
                          >
                      ...
                      <div className="mt-3 flex flex-col">
                        <button className="flex flex-row items-end gap-2 px-2 py-1 rounded-md hover:bg-slate-100 transition-all duration-200 ease-in-out">
                          ...
                          <span className="text-xs text-gray-700 hover:text-gray-900 transition-all duration-200 ease-in-out">
                            Create new
                          </span>
                        </button>
                      </div>
                ...
                {companyProfileMenu.map((menu, idx) => (
                  <div
                    ...
                    className="flex flex-row items-center gap-2 cursor-pointer hover:bg-gray-100 px-3 py-2 rounded-md transition-all duration-200 ease-linear"
                    key={idx}
                  >
