...
export default function Hero() {
  ...
  return (
    <section className="relative">
      <SkewedBackground />
      <div className="md:h-[480px] flex flex-col justify-center container z-30">
        <div className="grid md:grid-cols-2 grid-cols-1 gap-10 items-center pt-14">
          <div className="md:mt-0 mt-10">
            <h1 className="text-text font-bold lg:text-4xl text-4xl md:text-2xl">The <span className="text-primary">Easiest Way</span>
            ...
            <div className="flex mt-5">
              <div className="bg-white h-14 items-center rounded-md grid grid-cols-3">
                <div className="flex items-center gap-2 border-r border-neutral-100 justify-center px-5">
                  <div>
                    <Building2 size={14} strokeWidth={1.4} className="text-neutral-500" />
                  </div>
                  <input type="text" className="text-sm text-neutral-500 outline-none w-full" placeholder="Industry" />
                ...
                <div className="flex items-center gap-2 px-5">
                  ...
                  <input type="text" className="text-sm text-neutral-500 outline-none w-full" placeholder="Location" />
                  <ChevronDown size={18} className="text-neutral-500" />
                </div>
