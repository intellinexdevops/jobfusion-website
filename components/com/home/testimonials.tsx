...
import TestimonialCard from "../../card/textimonial-card";
...
export default function Testimonials() {
  ...
  return (
    <section className="container py-24">
      <p className="text-left uppercase text-3xl font-semibold">
        Customer&apos;s Testimonials
      </p>
      <p className="text-left text-neutral-500">
        Quotes from hired candidates and satisfied employers.
      </p>
