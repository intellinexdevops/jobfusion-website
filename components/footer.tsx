                        ...
                        <ul className='font-normal text-sm' >
                            {keywords.map((keyword) => (
                                <li key={keyword.name} className='mt-3 group' >
                                    <Link href="#" className='transition-all duration-300 ease-linear group-hover:ps-2 flex flex-row items-center gap-2 group-hover:font-medium' >
                                        <LinkIcon className='' size={13} />
                                        {keyword.name}
                                        <ChevronRight size={13} className='group-hover:opacity-100 opacity-0 transition-all duration-300 ease-linear' />
                                    </Link>
                                </li>
                            ))}
                        </ul>
                        ...
                        <ul className='font-normal text-sm' >
                            {routers.map((router) => (
                                <li key={router.name} className='mt-3' >
                                    <Link href={router.href} className='transition-all duration-300 ease-linear' >
                                        {router.name}
                                    </Link>
                                </li>
                            ))}
            ...
            <div className='border-t py-4 mt-10' >
                <div className='container flex flex-row justify-between' >
                    <div className='flex flex-row items-center gap-10' >
                        <p className='text-sm text-gray-500' >&copy; {year} JobFusion. All rights reserved.</p>
