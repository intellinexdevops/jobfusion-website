...
export default function HeaderNav() {
    ...
    return (
        <header className={`fixed top-0 z-50 left-0 right-0 bg-transparent transition-all duration-300 ease-linear ${scrolled ? ' bg-white/80 backdrop-blur-md border-b border-gray-100' : ''}`} >
