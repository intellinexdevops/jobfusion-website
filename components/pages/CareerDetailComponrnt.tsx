"use client"
import { Bookmark, Building, ChevronDown, ChevronRight, DownloadIcon, EarthIcon, LinkIcon, MailIcon, MessageCircleMore, PhoneIcon, StarIcon, UserCircleIcon, UserSquareIcon, Verified } from 'lucide-react'
...
export default function CareerDetailComponrnt() {
    ...
    return (
        <div className='mt-10' >
            <div className='container grid grid-cols-1 lg:grid-cols-12 mb-10' >
                <div className='col-span-8' >
                    ...
                    <div className='mt-5' >
                        <button className='flex flex-row items-center gap-5' onClick={() => setExpend(!expend)}>
                    ...
                    <div className='mt-5' >
                        ...
                        <ul className='list-disc leading-6 pl-5 text-xs mt-3' >
                            ...
                            <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
                            <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
                            <li>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, saepe!</li>
                        </ul>
                    </div>
                    ...
                    <div className='mt-5' >
                        ...
                        <ul className='list-disc leading-6 pl-5 text-xs mt-3' >
                            <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
                            <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus laboriosam ab quibusdam magnam optio ipsam voluptatibus!</li>
                        </ul>
                    </div>
                ...
                <div className='lg:col-span-4 lg:ms-10 pt-6 lg:pt-0' >
                    <div className='bg-white dark:bg-primary/5 p-5 rounded-lg' >
                        <div>
                            <p className='font-medium text-gray-500 text-xs'>About Recruiter</p>
                            <div className='flex flex-row items-center justify-between' >
                            ...
                            <div className='mt-5' >
                                <p className='font-medium text-xs text-gray-500'>Company Description</p>
                                <p className='text-sm leading-5 mt-1 line-clamp-2'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            </div>
                            <div className='mt-5' >
                    ...
                    <div className='bg-white dark:bg-primary/5 p-5 rounded-lg mt-3' >
                        ...
                        <div className='mt-3' >
                            <div className='flex flex-row items-center gap-2' >
                                ...
                                <div>
                                    <Link href="#" className='text-xs font-medium underline text-blue-500'>http://www.google.com</Link>
                                </div>
                            </div>
                        </div>
                    </div>
