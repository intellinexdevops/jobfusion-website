...
export default function CampaignApplication() {
  const [isSuccessApplied, setIsSuccessApplied] =
      ...
      >
        <div className="grid grid-cols-1">
          ...
          <div className="p-5">
            <form>
              ...
              <p className="font-medium text-xs text-gray-500 mt-8">
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={handleOnApplyNow}>
                      Apply Now
                    </AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
        ...
        <AlertDialog open={isOpen}>
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <AlertDialogCancel onClick={handleFeedbackCancel}>
                Close
              </AlertDialogCancel>
              <AlertDialogAction onClick={handleFeedback}>
                Submit
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
