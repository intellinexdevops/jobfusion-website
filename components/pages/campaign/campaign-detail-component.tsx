...
import BreadcrumbCom from "../../base/breadcrumb-com";
...
const CareerBreadCrumb = dynamic(
  () => import("../../com/campaign/campaign-breadcrumb")
);

export default function CampaignDetailComponent({ data }: { data: Job }) {
  const [expend, setExpend] = useState(false);
  const router = useRouter();
  const handleApply = () => {
    router.push("/297329437493/apply");
  };
