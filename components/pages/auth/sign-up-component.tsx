...
import SignUpWithEmailComponent from "../../com/auth/sign-up-with-email-component";
import SignUpWithPhoneComponent from "../../com/auth/sign-up-with-phone-component";
    ...
    <Modal>
      ...
      <div className="grid grid-cols-2 gap-3 mt-[30px]">
        ...
        <Button variant="outline" className="space-x-1" onClick={() => {}}>
          <Image src="/icons/google.svg" width={20} height={20} alt="Apple" />
          <Label className="text-gray-600 font-medium">Google</Label>
        </Button>
        <Button variant="outline" className="space-x-1">
          <Image src="/icons/linkedin.svg" width={20} height={20} alt="Apple" />
          <Label className="text-gray-600 font-medium">LinkedIn</Label>
        </Button>
        <Button variant="outline" className="space-x-1">
          <Image src="/icons/github.svg" width={20} height={20} alt="Apple" />
